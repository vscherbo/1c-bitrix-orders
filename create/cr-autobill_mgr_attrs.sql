...
CREATE OR REPLACE FUNCTION autobill_mgr_attrs(arg_bill_no integer, OUT out_mgr_email VARCHAR, OUT out_mgr_name VARCHAR, OUT out_firm_name VARCHAR)
RETURNS record
language plpgsql
AS
$BODY$
BEGIN
    ...
    INTO out_mgr_email, out_mgr_name, out_firm_name;
END
$BODY$
